...
export const shipmentsController = {
  ...
  retrieveByShipmentId: (async (req: Request, res: Response) => {
    try {
  ...
  updateByShipmentId: (async (req: Request, res: Response) => {
    try {
      const { shipmentId } = req.params;
      const {
        shipment_id,
  ...
  deleteByShipmentId: (async (req: Request, res: Response) => {
    try {
      const { shipmentId } = req.params;
