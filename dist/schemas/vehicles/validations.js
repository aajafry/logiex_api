...
exports.updateVehicleSchema = exports.insertVehicleSchema = void 0;
const zod_1 = require("zod");
const drizzle_zod_1 = require("drizzle-zod");
const index_1 = require("../index");
const enum_1 = require("../../utils/enum");
exports.insertVehicleSchema = (0, drizzle_zod_1.createInsertSchema)(index_1.vehicles, {
    make: zod_1.z
        .string({
    ...
    type: zod_1.z.enum(enum_1.vehicleTypesEnum),
});
exports.updateVehicleSchema = (0, drizzle_zod_1.createInsertSchema)(index_1.vehicles, {
    make: zod_1.z
        .string()
        .min(3, { message: "Make must be at least 3 characters long" })
        .max(80, { message: "Make must not exceed 80 characters" })
    ...
    cargo_capacity: zod_1.z
        ...
        .int({ message: "Cargo capacity must be an integer" })
        .optional(),
    type: zod_1.z.enum(enum_1.vehicleTypesEnum).optional(),
});
